...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <p class="animation__shake">testTask</p>
    </div>
    <!-- Navbar -->
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            <span class="brand-text font-weight-light">TestTask</span>
        </a>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2014-<?php echo e(now()->year); ?> <a href="<?php echo e(route('main.index')); ?>">testTask</a>.</strong>
    </footer>
